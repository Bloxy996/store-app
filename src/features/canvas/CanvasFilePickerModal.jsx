...
// tiny (no fuzzy scoring) since PaletteModal already owns the fuzzy
// switcher. Renders as a plain block below the (in-flow, non-scrolling)
// canvas toolbar rather than a modal-overlay — same "one shared panel below
// a static row" pattern as DbViewPanel/the tab-bar menu, since
// .canvas-toolbar is exactly that kind of fixed top row (CLAUDE.md popup
// pass 6).
function CanvasFilePickerModal({ files, onPick, onClose }) {
  ...
  return (
    <div className="canvas-file-picker-inline" ref={panelRef}>
