...
const HELP_FEATURES = [
  ...
  { title: 'Graph view', desc: 'The network icon in the activity bar (or ⌘/Ctrl K → "Open graph view") opens a full map of every wikilink in the store. Drag nodes, scroll to zoom, hover to see a note\'s connections, and click a node to jump straight to it. The sliders icon opens Filters, Groups (color notes matching text in their name), and Forces (repel/link/distance/center) — same three panels as Obsidian\'s graph view. Filters also has a Local graph toggle with a depth slider, showing just the notes connected to the one you have open instead of the whole vault.' },
